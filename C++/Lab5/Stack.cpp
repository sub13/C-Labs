...
{
	int size;
	string tempInputSize;
	T1 tempInput;
	cout << "Введите размер стека 1:\n";
	cin >> tempInputSize;
	if(tempInputSize.length() > 7)
	{
...
template <typename T1>
void pushStack(Stack& newstack,T1 elem)
{
